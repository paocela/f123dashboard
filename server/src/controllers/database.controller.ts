...
export class DatabaseController {
  ...
  async getDriversData(req: Request, res: Response): Promise<void> {
    try {
      const seasonId = req.body?.seasonId ? parseInt(req.body.seasonId) : undefined;
  ...
  async getChampionship(req: Request, res: Response): Promise<void> {
    try {
      const seasonId = req.body?.seasonId ? parseInt(req.body.seasonId) : undefined;
  ...
  async getCumulativePoints(req: Request, res: Response): Promise<void> {
    try {
      const seasonId = req.body?.seasonId ? parseInt(req.body.seasonId) : undefined;
  ...
  async getRaceResult(req: Request, res: Response): Promise<void> {
    try {
      const seasonId = req.body?.seasonId ? parseInt(req.body.seasonId) : undefined;
  ...
  async getConstructors(req: Request, res: Response): Promise<void> {
    try {
      const seasonId = req.body?.seasonId ? parseInt(req.body.seasonId) : undefined;
  ...
  async getConstructorGrandPrixPoints(req: Request, res: Response): Promise<void> {
    try {
      const seasonId = req.body?.seasonId ? parseInt(req.body.seasonId) : undefined;
  ...
  async setGpResult(req: Request, res: Response): Promise<void> {
    try {
      const {
        trackId,
        hasSprint,
      ...
      const result = await databaseService.setGpResult(
        trackId,
        hasSprint,
        raceResult,
        raceDnfResult,
