 ...
 */
export function getPasswordResetEmailTemplate(user: User, newPassword: string): { html: string; text: string } {
  const htmlMessage = `
    <!DOCTYPE html>
    <html>
    <head>
 ...
 */
export function getUpcomingRaceEmailTemplate(user: User, races: Race[]): { html: string; text: string; subject: string } {
